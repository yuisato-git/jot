    ...
    <div>
        ...
        <form @submit.prevent class="pt-2">
            ...
            <div class="flex justify-end">
                <button class="py-2 px-4 rounded text-red-700 border mr-5 hover:border-red-700 focus:outline-none" @click="$router.push('/contacts/' + $route.params.id)">Cancel</button>
